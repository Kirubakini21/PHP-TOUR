...
<body id="bdy-main">
	...
	$query = mysql_query("Select MAX(Sno) as data From SyllabusTable", $con);
	$row = mysql_fetch_array($query);
	$Id = $row['data']+1;

	?>

	<form action="AddSyllabusCode.php" method="post" enctype="multipart/form-data">
		
		<table class="tbl" align="center" >
			<tr>
				<td align="right">Syllabus Id:</td> 
			...
			<tr>
				<td align="right">Title/Information:</td> 
				<td>
