...
<body id="bdy-main">
	...
	$query = mysql_query("Select MAX(Sno) as data From MaterialTable", $con);
	$row = mysql_fetch_array($query);
	$Id = $row['data']+1;

	?>

	<form action="AddMaterialCode.php" method="post" enctype="multipart/form-data">
		...
		<table class="tbl" align="center" >
			...
			<tr>
				<td align="right">Title/Chapter:</td> 
				<td>
